...
replace (
	...
	// The version of client-go should align with other k8s.io dependencies to avoid compatibility issues.
	k8s.io/client-go => k8s.io/client-go v0.35.3
	k8s.io/component-base => k8s.io/component-base v0.35.3

	knative.dev/pkg => knative.dev/pkg v0.0.0-20260825072334-d2a153acc00c
)
...
replace code.gitea.io/gitea => code.gitea.io/gitea v1.25.5
